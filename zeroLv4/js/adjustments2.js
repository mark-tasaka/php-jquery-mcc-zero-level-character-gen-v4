...
function addItem(){
    var item = [
        ...
        {"id": 3, "item": ""},
        {"id": 4, "item": ""},
        {"id": 5, "item": "Flint fire starter<br/>"},
        {"id": 6, "item": "Hemp rope, 50 ft.<br/>"},
        {"id": 7, "item": "Jerked roxen meat<br/>"},
        {"id": 8, "item": "Leather rucksack<br/>"},
        {"id": 9, "item": "Torch (x3)<br/>"},
        {"id": 10, "item": "Bone necklace<br/>"},
        {"id": 11, "item": "Conch shell trumpet<br/>"},
        {"id": 12, "item": "Magic sticky rock (loadstone)<br/>"},
        {"id": 13, "item": "Paints & dyes<br/>"},
        {"id": 14, "item": "Bag of sea shells<br/>"},
        {"id": 15, "item": "Small shiny thing (trinket non-fuctional artifact)<br/>"},
        {"id": 16, "item": "Large shiny thing (trinket non-fuctional artifact)<br/>"},
        {"id": 17, "item": "A telepathic rat (pet)/1d3 attacks<br/>"}
    ];
